...
class AvgMZVisualization:
    ...
    def get_subsegmentation(self, img, roi_mask, avgmz, number_of_bins_for_comparison):
        ...
        num_bins = 2048
        region_heatmap = image_histogram_equalization(region_heatmap, roi_mask, num_bins) / (num_bins - 1)
    ...
    def visualize_factorization(self,
        ...
        sub_segmentation, heatmap = self.get_subsegmentation(img, roi_mask, avgmz, number_of_bins_for_comparison)
